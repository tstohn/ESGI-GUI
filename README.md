...
The GUI separetes demultiplexing and counting and the user needs to first *demultiplex* the data and cen then subsequently create a single-cell * feature count matrix by running *count*.
